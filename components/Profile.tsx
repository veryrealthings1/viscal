...
const Profile: React.FC = () => {
  const { dailyGoal, setDailyGoal, userProfile, setUserProfile, addWeightEntry, resetData } = useData();
  ...
  const handleResetData = () => {
      if (window.confirm("Are you sure you want to reset all your data? This action is permanent and cannot be undone.")) {
          resetData();
          onClose();
                 ...
                 <div className="animate-fade-in space-y-6">
                    ...
                    <div className="space-y-3">
                     ...
                     <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                        <button onClick={handleResetData} className="w-full flex items-center justify-center gap-3 py-3 px-4 border-2 border-red-500/50 text-red-500 bg-red-500/5 dark:bg-red-500/10 rounded-lg hover:bg-red-500/10 dark:hover:bg-red-500/20 transition-colors font-semibold">
